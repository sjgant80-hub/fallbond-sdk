...
**FallBond · the two-agent bonding ceremony · sovereign · runs in your browser** — sovereign SDK extracted from `fallbond/index.html`.

## Install
```bash
npm install @ai-native-solutions/fallbond-sdk
```

## Use
```js
import * as fallbond from '@ai-native-solutions/fallbond-sdk';
```

- Playground: https://sjgant80-hub.github.io/fallbond-sdk/
- MCP wrapper: [`@ai-native-solutions/fallbond-mcp`](https://github.com/sjgant80-hub/fallbond-mcp)
- HTTP API: [`@ai-native-solutions/fallbond-api`](https://github.com/sjgant80-hub/fallbond-api)
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallbond-sdk](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallbond-sdk)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallbond-sdk-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallbond-sdk -- npx -y @ai-native-solutions/fallbond-sdk-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallbond-sdk-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallbond-sdk
- **Live URL**: https://sjgant80-hub.github.io/fallbond-sdk/
- **Source**: https://github.com/sjgant80-hub/fallbond-sdk
